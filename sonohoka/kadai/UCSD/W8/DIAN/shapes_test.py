"""Final Answers for shapes Unit testing for Python Fundamentals."""
import unittest
...
class PointTests(unittest.TestCase):
    ...
    def test_scalar_mult_right(self):
        ...
        point1 = Point(2, 3)
        point2 = point1 * 3
        # Ensure original point unchanged
        self.assertEqual(point_data(point1), expected1)
        self.assertEqual(point_data(point2), expected2)
...
class CircleTests(unittest.TestCase):
    ...
    def test_circle_point_objects_different(self):
        ...
        # In other words, they should be the same VALUES,
        # But NOT the same objects.
        circle1 = Circle()
        circle2 = Circle()
